...
const startServer = async () => {
  try {
    ...
    await initQueue().catch((err) => logger.warn("Queue init skipped:", err.message));

    // Schedule file cleanup
    try { scheduleFileCleanup(); } catch (err) { logger.warn("Cleanup scheduler failed:", err.message); }
